export interface VagaEstagio {
  ...
  carta_apresentacao_text_pt?: string // Texto da carta de apresentação em Português
  carta_apresentacao_text_en?: string // Texto da carta de apresentação em Inglês
...
export interface CandidateProfile {
  ...
  tagline_pt: string
  tagline_en: string
  curriculo_geral_md: string
  curriculo_geral_md_en: string
  habilidades: Array<{
    category_pt: string
    category_en?: string
    items_pt: string[]
