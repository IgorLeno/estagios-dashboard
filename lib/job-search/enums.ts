...
export const LABELS: Record<string, string> = {
  ...
  FORA: "Fora da área",
  // Interest factors, jornada and risks (dossier/1): display names only, never rules.
  LOCAL_BH_RMBH: "Local em BH / RMBH",
  SETOR_AMPLIFICADOR: "Setor amplificador",
  OPORTUNIDADE_EXCEPCIONAL: "Oportunidade excepcional",
  HORARIO_07_15: "Horário 07h–15h",
  HORARIO_09_17: "Horário 09h–17h",
  OUTRO_HORARIO_ATE_8H: "Outro horário (até 8h)",
  JORNADA_ACIMA_8H_HABITUAL: "Jornada acima de 8h habitual",
  FIM_DE_SEMANA_REGULAR: "Fim de semana regular",
  TURNO_NOTURNO: "Turno noturno",
  TURNO_ROTATIVO: "Turno rotativo",
  TURNO_TARDE_NOITE: "Turno tarde/noite",
  CAMPO_PREDOMINANTE: "Trabalho de campo predominante",
  LABORATORIO_PREDOMINANTE_SEM_PROCESSO: "Laboratório predominante, sem processo",
  SETOR_BAIXO_INTERESSE: "Setor de baixo interesse",
  REQ_TEMPO_EXPERIENCIA: "Tempo de experiência exigido",
  REQ_EXPERIENCIA_PROFISSIONAL: "Experiência profissional exigida",
  CAPACIDADE_AUSENTE_EXIGIDA: "Capacidade ausente exigida",
  FORMACAO_CONCLUIDA_EXIGIDA: "Formação concluída exigida",
  REGISTRO_CREA_CRQ: "Registro CREA/CRQ",
  RESIDENCIA_EXIGIDA: "Residência exigida",
  TITULO_ENGENHEIRO: "Título de engenheiro",
  CERTIFICADO_IDIOMA: "Certificado de idioma",
  RESOLVED: "Resolvido",
  NEEDS_HUMAN: "Precisa de decisão humana",
  ANALISE: "Análise",
  FORMULARIO: "Formulário",
  REVIEW: "Revisão humana",
  CONFIRM: "Confirmação",
  AUTO: "Automático",
  PORTAL_NOTES: "Notas do portal",
  POSTING: "Publicação",
  SETOR_EMPRESA: "Setor da empresa",
  CONTEXTO_DE_APLICACAO: "Contexto de aplicação",
  LOCAL_DE_TRABALHO: "Local de trabalho",
  MODALIDADE: "Modalidade",
  CLAIMED: "Tentativa iniciada",
  DRAFT_POSSIBLE: "Rascunho possível",
  DRAFT_CONFIRMED: "Rascunho confirmado",
  SUBMIT_INTENT: "Intenção de envio",
  SUBMITTED: "Enviada",
  SUBMIT_UNCERTAIN: "Envio incerto",
  CLOSED: "Encerrada",
}
